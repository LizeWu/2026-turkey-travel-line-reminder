...
GitHub is the source of truth for code and shareable settings. Codex chat history is helpful context, but it is not the source of truth.
...
每次開始前先讀 LizeNext.md、PROJECT_HANDOFF.md、WORKLOG.md、FILE_INDEX.md、docs/ai-development-sop.md。
